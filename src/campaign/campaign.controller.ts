...
export class CampaignController {
  ...
  @Post()
  async createCampaign(@Body() createCampaignDto: CreateCampaignDto): Promise<{ message: string; shareableLink: string }> {
    const campaign: CampaignDocument = await this.campaignService.createCampaign(createCampaignDto);
    return {
